...
adRouter.get('/MyPosts',function(req, res){
	...
	if(currentSession.username==undefined){
		...
		Post.find({author : currentSession.userId },function(err, data){
			...
			if(err)
				...
				res.render('userMyPosts',{ username: currentSession.username , posts : posts });
